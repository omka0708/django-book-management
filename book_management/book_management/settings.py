...
SECRET_KEY = 'django-insecure-ca)^!fafa#4vki*+__t6yx&u1p$@30%-d#$f2m547ho%b_68&v'
...
CELERY_BROKER_URL = f"{os.getenv('REDIS_LOCATION')}/0"
CELERY_RESULT_BACKEND = f"{os.getenv('REDIS_LOCATION')}/0"
